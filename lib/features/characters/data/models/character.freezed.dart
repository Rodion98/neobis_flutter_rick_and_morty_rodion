...
class _$CharacterImpl with DiagnosticableTreeMixin implements _Character {
  const _$CharacterImpl(
      {required final List<Results> results, required this.info})
      : _results = results;
...
abstract class _Character implements Character {
  const factory _Character(
      ...
      required final Info info}) = _$CharacterImpl;
...
abstract class _Results implements Results {
  const factory _Results(
      ...
      required final DateTime created}) = _$ResultsImpl;
...
abstract class _CharacterLocation implements CharacterLocation {
  const factory _CharacterLocation(
      {required final String name,
      required final String url}) = _$CharacterLocationImpl;
